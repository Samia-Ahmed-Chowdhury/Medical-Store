...
<br>       
        ...
        <br>
          ...
          $count=0;
          $today=date('Y-m-d');
 $res=mysqli_query($link,"select * from add_product where purchase_pack <20  order by id asc");
...
<td><a href="update_product.php?id=<?php echo $row["id"];?>" style="color:#66CDAA;"><strong>Update</strong> </a>  ||  
<a onclick="return confirm('Are U sure to Remove? ')" href="product_delete.php?id=<?php echo $row["id"];?>" style="color:#FF84A7;"><strong>Remove</strong></a> </td> 
 <?php
